...
function UpdateProfileForm({ appUser, children }) {
  const { fullname, email, access_type, is_active } = appUser;
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        <label htmlFor="userRole">Select access type...</label>
        {children}
      </div>
      ...
      <div className="flex justify-between gap-6">
        ...
        <ActionButton pendingText={'Updating...'}>Update Profile</ActionButton>
      </div>
    </form>
  );
}
