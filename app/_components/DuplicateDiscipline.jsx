...
// import { duplicateDiscipline } from "@/app/_lib/actions_masts";

function DuplicateDiscipline({ copiedRow, onDelete }) {
  const [isPending, startTransition] = useTransition();

  function handleDuplicate() {
    if (confirm("Are you sure you want to duplicate this record?"))
      startTransition(() => duplicateDiscipline(copiedRow));
...
export default DuplicateDiscipline;
